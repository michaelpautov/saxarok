...
<step number="1" subagent="project-manager" name="tasks_list_check">

### Step 1: Tasks Completion Verification
...
<step number="2" subagent="project-manager" name="roadmap_progress_check">

### Step 2: Roadmap Progress Update (conditional)
...
<step number="3" subagent="project-manager" name="document_recap">

### Step 3: Create Recap Document
...
<step number="4" subagent="project-manager" name="completion_summary">
...
<summary_template>
  ...
  All changes have been completed and documented.
  You can now commit and push your changes when ready.
</summary_template>
...
<step number="5" subagent="project-manager" name="completion_notification">

### Step 5: Task Completion Notification
